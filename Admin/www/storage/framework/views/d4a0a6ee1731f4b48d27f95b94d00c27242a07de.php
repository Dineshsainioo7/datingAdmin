<?php $__env->startSection('title', __('labels.backend.interest.management') . ' | ' . __('labels.backend.interest.create')); ?>
...
<?php $__env->startSection('content'); ?>
    <?php echo e(html()->form('POST', route('admin.interest.store'))->class('form-horizontal')->open()); ?>
                ...
                <div class="row">
                    <div class="col-sm-5">
                        <h4 class="card-title mb-0">
                            ...
                            <small class="text-muted"><?php echo app('translator')->getFromJson('labels.backend.interest.create'); ?></small>
                        </h4>
                    </div><!--col-->
                </div><!--row-->
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <label class="switch switch-label switch-pill switch-primary">
                                        <?php echo e(html()->checkbox('status', true)->class('switch-input')); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp32\www\loai\dating\www\resources\views/backend/activities/interests/create.blade.php ENDPATH**/ ?>