        ...
        <div class="col col-sm-8 align-self-center">
            <div class="card">
                <div class="card-header">
                    <strong>
                        <?php echo app('translator')->getFromJson('labels.frontend.auth.login_box_title'); ?>
                    </strong>
                </div><!--card-header-->
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group text-right">
                                    <a href="<?php echo e(route('frontend.auth.password.reset')); ?>"><?php echo app('translator')->getFromJson('labels.frontend.passwords.forgot_password'); ?></a>
                                </div><!--form-group-->
                            </div><!--col-->
                        </div><!--row-->
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp32\www\loai\dating\www\resources\views/frontend/auth/login.blade.php ENDPATH**/ ?>