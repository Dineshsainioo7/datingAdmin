<?php echo e(html()->modelForm($logged_in_user, 'POST', route('frontend.user.profile.update'))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->open()); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\wamp32\www\loai\dating\www\resources\views/frontend/user/account/tabs/edit.blade.php ENDPATH**/ ?>