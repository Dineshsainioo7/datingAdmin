...
<?php echo e(html()->form('PATCH', route('admin.user.password-update', $user))->class('form-horizontal')->open()); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp32\www\loai\dating\www\resources\views/backend/auth/user/change-password.blade.php ENDPATH**/ ?>