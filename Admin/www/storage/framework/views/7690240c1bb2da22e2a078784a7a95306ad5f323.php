        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    ...
                    <small class="text-muted"><?php echo app('translator')->getFromJson('labels.backend.access.users.deactivated'); ?></small>
                </h4>
            </div><!--col-->
        </div><!--row-->
            ...
            <div class="col">
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <?php else: ?>
                            <tr><td colspan="9"><p class="text-center"><?php echo app('translator')->getFromJson('strings.backend.access.users.no_deactivated'); ?></p></td></tr>
                        <?php endif; ?>
                        </tbody>
                    </table>
                </div>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp32\www\loai\dating\www\resources\views/backend/auth/user/deactivated.blade.php ENDPATH**/ ?>