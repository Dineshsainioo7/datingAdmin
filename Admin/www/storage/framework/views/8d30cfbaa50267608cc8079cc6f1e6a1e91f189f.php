<?php $__env->startSection('title', __('labels.backend.plan_privilege.management') . ' | ' . __('labels.backend.plan_privilege.create')); ?>
...
<?php $__env->startSection('content'); ?>
     <?php echo Form::open(['route' => ['admin.plan-privilege.store'], 'id'=>'myForm', 'files'=>true]); ?>
                ...
                <div class="row">
                    <div class="col-sm-5">
                        <h4 class="card-title mb-0">
                            ...
                            <small class="text-muted"><?php echo app('translator')->getFromJson('labels.backend.plan_privilege.create'); ?></small>
                        </h4>
                    </div><!--col-->
                </div><!--row-->
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp32\www\loai\dating\www\resources\views/backend/plans/plan_privilege/create.blade.php ENDPATH**/ ?>