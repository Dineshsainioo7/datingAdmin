        ...
        <div class="col col-sm-6 align-self-center">
            <div class="card">
                <div class="card-header">
                    <strong>
                        <?php echo app('translator')->getFromJson('labels.frontend.passwords.expired_password_box_title'); ?>
                    </strong>
                </div><!--card-header-->
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp32\www\loai\dating\www\resources\views/frontend/auth/passwords/expired.blade.php ENDPATH**/ ?>