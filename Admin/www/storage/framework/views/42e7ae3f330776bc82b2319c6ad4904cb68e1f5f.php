<?php $__env->startSection('title', __('labels.backend.pages.management') . ' | ' . __('labels.backend.pages.create')); ?>
...
<?php $__env->startSection('content'); ?>
     <?php echo Form::open(['route' => ['admin.pages.store'], 'id'=>'myForm', 'files'=>true]); ?>
                ...
                <div class="row">
                    <div class="col-sm-5">
                        <h4 class="card-title mb-0">
                            ...
                            <small class="text-muted"><?php echo app('translator')->getFromJson('labels.backend.pages.create'); ?></small>
                        </h4>
                    </div><!--col-->
                </div><!--row-->
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp32\www\loai\dating\www\resources\views/backend/static_pages/create.blade.php ENDPATH**/ ?>