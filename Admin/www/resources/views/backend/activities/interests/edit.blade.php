...
@section('title', __('labels.backend.interest.management') . ' | ' . __('labels.backend.interest.edit'))
...
@section('content')
    {{ html()->modelForm($interest, 'PATCH', route('admin.interest.update', $interest->id))->class('form-horizontal')->open() }}
                ...
                <div class="row">
                    <div class="col-sm-5">
                        <h4 class="card-title mb-0">
                            ...
                            <small class="text-muted">@lang('labels.backend.interest.edit')</small>
                        </h4>
                    </div><!--col-->
                </div><!--row-->
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <label class="switch switch-label switch-pill switch-primary">
                                        {{ html()->checkbox('status',($interest->status == 1)? true : false  )->class('switch-input') }}
