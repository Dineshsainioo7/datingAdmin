...
// Status
  Route::get('user/changestatus/{status}', [UserController::class, 'changeStatus'])->name('user.changestatus');
  // Password
  Route::get('password/change/{id}', [UserController::class, 'changePassword'])->name('user.change-password');

  Route::patch('password/change/{id}', [UserController::class, 'updatePassword'])->name('user.password-update');
 Route::get('user/deactivated', [UserController::class, 'getDeactivated'])->name('user.deactivated');

  Route::get('user/state', [UserController::class, 'state'])->name('user.state');
  Route::get('user/city', [UserController::class, 'city'])->name('user.city');
